...
Only Sprint 7 — Shadow Coach is currently in scope. COROS remains read-only. Do not implement
persistence, API endpoints, LLM integration, or write-back prematurely.
